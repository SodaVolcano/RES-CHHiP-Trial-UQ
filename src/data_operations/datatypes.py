...
from typing import Any, Generator, Iterable, Iterator, List, Union
from dataclasses import dataclass
from src.globals import MaskType, VolumeType
...
class Mask:
    ...
    __organs: dict[str, Union[Generator[MaskType, None, None], MaskType]]
    observer: str = ""
...
class PatientScan:
    ...
    __volume: Union[Generator[VolumeType, None, None], VolumeType]
