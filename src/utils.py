...
import pickle
from typing import Any, Callable, Iterable, List, Generator, Union, TypeVar
import os
...
def unpack_args(func: Callable) -> Callable:
    """
...
@curry
def apply_if_truthy_else_None(func: Callable, arg: Any) -> Union[Any, None]:
    """
    Apply func to arg if arg is truthy (e.g. not None, [], ...), otherwise return None
    """
