...
class Test_MostCommonShape:
    ...
    def test_most_common_shape_uniform(self):
        dicom_files = [dicom.Dataset(), dicom.Dataset(), dicom.Dataset()]
        for d in dicom_files:
            d.Rows, d.Columns = 512, 512
        from src.data_operations.load_dicom import _most_common_shape
...
class Test_FilterByMostCommonShape:
    ...
    def test_filters_by_most_common_shape(self):
        ...
        from src.data_operations.load_dicom import _filter_by_most_common_shape
...
class TestLoadVolume:
    ...
    def test_loads_3d_volume_correctly(self, mocker):
        ...
        mocker.patch(
            "src.data_operations.data_loading_dicom.list_files",
        ...
        mock_dicom.SOPClassUID = g.CT_IMAGE
        mock_dicom.Rows = 512
        ...
        from src.data_operations.load_dicom import load_volume
    ...
    def test_no_dicom_files_in_directory(self, mocker):
        ...
        mocker.patch(
            "src.data_operations.data_loading_dicom.list_files", return_value=[]
        )
        from src.data_operations.load_dicom import load_volume
    ...
    def test_loads_3d_volume_with_most_common_shape(self, mocker):
        ...
        mock_dicom1.SOPClassUID = g.CT_IMAGE
        ...
        mock_dicom2.SOPClassUID = g.CT_IMAGE
        ...
        mock_dicom3.SOPClassUID = g.CT_IMAGE
        ...
        mocker.patch(
            "pydicom.dcmread", side_effect=[mock_dicom1, mock_dicom2, mock_dicom3]
        )
        from src.data_operations.load_dicom import load_volume
...
class Test_LoadRtStruct:
    ...
    def test_loads_rtstructbuilder_successfully(self, mocker):
        ...
        mock_dicom_file.SOPClassUID = g.RT_STRUCTURE_SET
        ...
        mocker.patch("pydicom.dcmread", return_value=mock_dicom_file)
        from src.data_operations.load_dicom import _load_rt_struct
...
class TestLoadMask:
    ...
    def test_load_mask_success(self, mocker):
        ...
        mocker.patch(
            "src.data_operations.data_loading_dicom._load_rt_struct",
            return_value=mock_rt_struct,
        )
        from src.data_operations.load_dicom import load_mask
    ...
    def test_load_mask_empty_directory(self, mocker):
        ...
        mocker.patch(
            "src.data_operations.data_loading_dicom._load_rt_struct", return_value=None
        )
        from src.data_operations.load_dicom import load_mask
...
class TestLoadPatientScan:
    ...
    def test_loads_patient_scan_with_valid_dicom_files(self, mocker):
        ...
        mocker.patch(
            "src.data_operations.data_loading_dicom.load_volume",
        ...
        mocker.patch(
            "src.data_operations.data_loading_dicom.load_mask", return_value=mock_mask
        )
        from src.data_operations.load_dicom import (
            load_patient_scan,
            PatientScan,
        )
    ...
    def test_no_dicom_files_in_directory(self, mocker):
        ...
        mocker.patch(
            "pydicom.dcmread", side_effect=IndexError("list index out of range")
        )
        ...
        mocker.patch(
            "src.data_operations.data_loading_dicom.load_mask", return_value=None
        )
...
class TestLoadPatientScans:
    ...
    def test_loads_multiple_patient_scans_successfully(self, mocker):
        ...
        mocker.patch("os.listdir", return_value=["patient1", "patient2"])

        # Mock the generate_full_paths to return full paths
        mocker.patch(
            "src.data_operations.data_loading_dicom.generate_full_paths",
        ...
        mocker.patch(
            "src.data_operations.data_loading_dicom.load_patient_scan",
    ...
    def test_handles_empty_directory_gracefully(self, mocker):
        ...
        from src.data_operations.load_dicom import load_patient_scans
    ...
    def test_correctly_processes_single_patient_scan(self, mocker):
        ...
        mocker.patch("os.listdir", return_value=["patient1"])
...
class TestLoadAllMasks:
    ...
    def test_loads_masks_from_valid_dicom_directory(self, mocker):
        ...
        mocker.patch("os.listdir", return_value=["file1.dcm", "file2.dcm"])
        from src.data_operations.load_dicom import load_all_masks
        from src.data_operations.datatypes import Mask

        mocker.patch(
            "src.data_operations.data_loading_dicom.load_mask",
            side_effect=[
